...
|---------|-------------|-------------------------|
| [GCP Serverless API Data Pipeline](https://github.com/roshkhan2000/GCP-Serverless-API-Data-Pipeline) | A pipeline that ingests API data hourly, stores it to blob storage, and loads it to a warehouse for analysis. | GCP, Python, REST API, Functions, Cloud Scheduler, Cloud Storage, BigQuery, SQL |
...
| [Ready, Set, Schema!](https://github.com/roshkhan2000/sql-olympics) | A pipeline that ingests a CSV file, loads it into a staging area, and materialises it as a table. This table is then transformed into multiple downstream dbt tables organised into bronze, silver, and gold models. | Snowflake, SQL, dbt, DDL DML, staging, data modelling |
...
`2x Viz Of The Day`<br> 


[Gym Tracker | #VOTD](https://public.tableau.com/app/profile/roshaan.khan/viz/GymTracker/GymTracker) |
...
[52 Weeks & 52 Charts of 2025](https://public.tableau.com/app/profile/roshaan.khan/viz/52Weeks52Chartsof2025/Dashboard) <br>
...
<div align="center">
  <a href="https://public.tableau.com/app/profile/roshaan.khan/viz/GymTracker/GymTracker">
  <img src="https://github.com/user-attachments/assets/4d4b98e0-78b2-4455-8400-29c99f8800c6" width="32%">
</a>
...
- [Using Notion API with Alteryx](https://www.thedataschool.co.uk/rosh-khan/using-notion-api-with-alteryx/)
...
<p align="center">
    <!-- Dribbble / Blog -->
  <a href="https://public.tableau.com/app/profile/roshaan.khan/vizzes" target="_blank" rel="noreferrer">
    <picture>
